...
class Elementor_Twitch_Stream_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Twitch Stream', 'wp-twitch-stream');
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            array(
                'label' => __('Stream Einstellungen', 'wp-twitch-stream'),
        ...
        $this->start_controls_section(
            'info_section',
            array(
                'label' => __('Stream-Informationen', 'wp-twitch-stream'),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            )
        );
        ...
        $this->start_controls_section(
            'style_section',
            array(
                'label' => __('Styling', 'wp-twitch-stream'),
        ...
        $this->add_group_control(
            ...
            array(
                'name' => 'border',
                'label' => __('Rahmen', 'wp-twitch-stream'),
        ...
        $this->add_control(
            'border_radius',
            array(
                'label' => __('Eckradius', 'wp-twitch-stream'),
        ...
        $this->add_group_control(
            ...
            array(
                'name' => 'box_shadow',
                'label' => __('Schatten', 'wp-twitch-stream'),
                'selector' => '{{WRAPPER}} .twitch-stream-container',
            )
        );
    ...
    protected function render() {
        ...
        if ($settings['show_info'] === 'yes') {
            ...
            echo wp_twitch_stream_info_shortcode($info_atts);
        }
    }
    ...
    protected function _content_template() {
        ...
        <#
        if (settings.channel) {
            var streamShortcode = '[twitch_stream channel="' + settings.channel + '" width="' + settings.width + '" height="' + settings.height + '" autoplay="' + (settings.autoplay ? 'true' : 'false') + '" muted="' + (settings.muted ? 'true' : 'false') + '"]';
            
            print(streamShortcode);
            
            if (settings.show_info) {
                var infoShortcode = '[twitch_stream_info channel="' + settings.channel + '" layout="' + settings.info_layout + '" show_avatar="' + (settings.show_avatar ? 'true' : 'false') + '" show_thumbnail="' + (settings.show_thumbnail ? 'true' : 'false') + '" show_game="' + (settings.show_game ? 'true' : 'false') + '" show_viewers="' + (settings.show_viewers ? 'true' : 'false') + '"]';
                print(infoShortcode);
            }
        } else {
